...
//                deleteDirRoom(new File(MyApplication.VIDEO_PATH), output);
    ...
    public static String VIDEO_PATH = "/sdcard/WeiXinRecordedDemo/Video/";
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.iv_back) {
            ...
            Intent intent = new Intent(VideoMainActivity.this, EditVideoActivity.class);
        ...
        } else if (i == R.id.iv_change_flash) {
