...
public class SpUtils {
    ...
    private static String WRITE_LV_TITLE = "write_lv_title";
    private static String WRITE_LV_TIME = "write_lv_time";
    private static String WRITE_LV_PIC = "write_lv_pic";
    private static String WRITE_LV_VOICE = "write_lv_voice";
    private static String WRITE_LV_PICPATH = "write_lv_pic_path";
    private static String WRITE_LV_VOICEPATH = "write_lv_voice_path";
    private static String WRITE_LV_INFO = "write_lv_info";
    ...
    public String getWriteLvTitle() {
        return getString(WRITE_LV_TITLE);
    }

    public void setWriteLvTitle(String title) {
        setString(WRITE_LV_TITLE, title);
    }
