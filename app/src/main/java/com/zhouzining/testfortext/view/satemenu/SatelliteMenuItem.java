package com.zhouzining.testfortext.view.satemenu;
...
public class SatelliteMenuItem {
    ...
    private LinearLayout clonelayout;
    ...
    public LinearLayout getClonelayout() {
        return clonelayout;
    }

    public void setClonelayout(LinearLayout clonelayout) {
        this.clonelayout = clonelayout;
    }
